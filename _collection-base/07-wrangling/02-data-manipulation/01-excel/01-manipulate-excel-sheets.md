...
order: 721.1
level: 2
categories: ["data-manipulation", "data-preview", "visualization", "plotting"]
tags: ["spreadsheet", "data-entry", "data-cleaning", "data-formatting", "excel", "Google Sheets", "Apple Numbers", "LibreOffice Calc"]
attributes: []
---
...
<button class="btn more"></button> ...at the official <a href="https://www.microsoft.com/en-us/microsoft-365/excel" target="_blank">Excel website  ⤴</a>
...
<button class="btn more"></button> ...at the official <a href="https://www.google.com/sheets/about/" target="_blank">Google Sheets website  ⤴</a>
...
<button class="btn more"></button> ...at the official <a href="https://www.libreoffice.org/discover/calc/" target="_blank">LibreOffice Calc website  ⤴</a>
...
<button class="btn more"></button> ...at the official <a href="https://www.apple.com/numbers/" target="_blank">Apple Numbers website  ⤴</a>
...
Manipulating data in spreadsheets is an essential task in scientific projects and research. Scientists and researchers often collect and organize large amounts of data in spreadsheets, which they then use to perform statistical analyses and create visualizations that help them gain insights into data.
...
<div class="note before" markdown="1" data-before="EXCEL">
...
## Learn from <button class="btn c-good">HANDS-ON TUTORIALS</button>
