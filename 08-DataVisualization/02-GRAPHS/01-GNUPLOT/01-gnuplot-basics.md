...
| ![labels](../../assets/images/gnuplot_with_labels.png) |labels &emsp; **#** | - | - | font 'Arial, 14' |  textcolor VAL <br> **tc 'red'** | textcolor palette | T / T | - |
...
![Gnuplot siple graph](../../assets/images/gnuplot_terminals.png)<br>
